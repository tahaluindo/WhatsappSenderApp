...
namespace WASender
{
    public class AutomationCommon
    {
        ...
        public static string GenerateReport(WASenderGroupTransModel wASenderSingleTransModel)
        {
            ...
            strim += "</tbody></table><button type=\"button\" onClick='downloadDiv( document.getElementsByTagName(\"h1\")[0].innerText+\".html\",document.body.innerHTML,\"text/html\");'> Download Report</a></div></div></body>" + script;
        ...
        public static string GenerateReport(WASenderSingleTransModel wASenderSingleTransModel)
        {
            ...
            strim += "</tbody></table><button type=\"button\" onClick='downloadDiv( document.getElementsByTagName(\"h1\")[0].innerText+\".html\",document.body.innerHTML,\"text/html\");'> Download Report</a></div></body>" + script;
